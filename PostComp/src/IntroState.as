package
{
	...
	public class IntroState extends FlxState
	{
		...
		override public function create():void
		{
			...
			var intro:FlxText = new FlxText(FlxG.width*0.5-175,FlxG.height*0.5-190, 350, text);
			intro.setFormat(null,15,0xFFFF00, "center");
			add(intro);
			
			var instruct:FlxText = new FlxText(FlxG.width*0.5-75,FlxG.height-20, 150, "PRESS [x] TO CONTINUE");
