package
{
	...
	public class PlayState extends FlxState
	{
		...
		{
			hud = new FlxText(0,370, 150, "Aloneium: " + Registry.metal.toString());
			hud.setFormat(null,10,0xFFFFFF, "left");
			add(hud);
			lives = new FlxText(350,370, 150, "Lives: " + Registry.lives.toString());
		...
		{
			Enemy.Health -= Registry.weaponDamage;
			FlxG.play(Registry.hit);
			b.kill();
			...
			if(Enemy.Health == 0)
			{
				...
				add(emitter);
				emitter.start(true,3);	
				Enemy.Health = Registry.enemyHealth;
			}
		}
